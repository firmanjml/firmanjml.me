...
const IndexPage = () => {
    return (
        <Layout>
            ...
            <p>I am currently working on my own project called <a href="https://www.kibblepaw.com" target="__blank" rel="noopener noreferrer">KibblePaw</a> - a platform for people to adopt or sell merchandise associating with Pets.</p>
